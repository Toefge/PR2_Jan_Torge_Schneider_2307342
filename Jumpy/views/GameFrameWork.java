...
public class GameFrameWork {
	...
	private void init() {
		...
		gameFrame.addKeyListener(new KeyAdapter() {
			...
			// Überschreibt die Methode keyReleased aus der Klasse KeyAdapter.
			// In der if-Schleife muss im Vergleich zu keyPressed lediglich die Methode
			// keyDown durch keyUp ersetzt werden.
			@Override
